...
export class QuizComponent {
  ...
  ngOnInit() {
    ...
    const pool = [
      ...
      { src: 'images/skater-fake.jpeg', isAI: true },
      { src: 'images/lake-fake.png', isAI: true },
      { src: 'images/lake-fake2.jpeg', isAI: true },
      { src: 'images/landscape-fake.png', isAI: true },
      { src: 'images/supra-fake.jpg', isAI: true },
      { src: 'images/swing-fake.jpg', isAI: true },
      { src: 'images/swing-fake2.jpeg', isAI: true },
      ...
      { src: 'images/elefant-real.jpg', isAI: false },
      { src: 'images/skater-real.jpg', isAI: false },
      { src: 'images/skyscraper-real.jpg', isAI: false },
      { src: 'images/market-real.jpg', isAI: false },
      { src: 'images/indian-lady-real.jpg', isAI: false },
      { src: 'images/landscape-real.jpg', isAI: false },
      { src: 'images/spider-real.jpg', isAI: false },
      { src: 'images/leaf-real.jpg', isAI: false },
      { src: 'images/clouds-real.jpg', isAI: false },
      { src: 'images/trees-real.jpg', isAI: false },
      { src: 'images/trees-real2.jpg', isAI: false },
      { src: 'images/goose-real.jpg', isAI: false },
      { src: 'images/leaf-real2.jpg', isAI: false },
      { src: 'images/lightning-real.jpg', isAI: false },
      { src: 'images/tunnel-real.jpg', isAI: false },
    ];
